...
<body>
                ...
                <div class="container-fluid">
                    <div class="mb-3 d-flex justify-content-between">
                        ...
                        <input
                            ...
                            type="button"
                            value="Crear cotizaciones nueva"
                        />
    ...
    <div class="contenido-modal">
        ...
        <p>Esto es el texto de la ventana</p>
                    ...
                    <?php
// Conexion para traer todos los registros de los clientes
...
//     echo "<thead>";
//     echo "<tr><th>Id</th><th>Imagen</th><th>Producto</th><th>Categoria</th><th>Precio (IVA)</th><th>Descripcion</th></tr>";
//     echo "</thead>";
//     echo "<tbody>";
//     while($row = mysqli_fetch_assoc($result)) {
//         echo "<tr>";
//         echo "<td>" . $row["Id_producto"] . "</td>";
//         echo "<td>" . $row["imagen_producto"] . "</td>";
